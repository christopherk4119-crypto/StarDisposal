...
export const siteServices: Service[] = [
  {
    ...
    description:
      "Small demolition in Calgary and Airdrie — garages, sheds, decks, fences and interior strip-outs, with haul-away included. 403-204-7827.",
    summary:
    ...
    process: [
      {
        step: "Send photos",
        detail:
          "Text a few to 403-204-7827. For demolition, photos get you a far more accurate number than a phone description.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "It depends on size, what it is built from, whether the concrete slab is coming out, and access. A standard detached garage on a back alley is a straightforward job. Text photos to 403-204-7827 for an accurate number.",
      },
      {
...

  {
    ...
    description:
      "Bobcat and skid steer work in Calgary and Airdrie — site prep, grading, material moving and debris piles. Call 403-204-7827.",
    summary:
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Call 403-204-7827 and describe both halves of the job at once so we bring the right setup the first time.",
        ],
      },
    ],
    included: [
    ...
    process: [
      {
        ...
        detail:
          "Call 403-204-7827. The first question is always whether the machine can physically get to the work — gate widths, side yards, alley access.",
      },
      {
...

  {
    ...
    description:
      "Construction and property site clean-up in Calgary and Airdrie. Final clear-down before handover or possession. Call 403-204-7827.",
    summary:
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          ...
          "Practically, these jobs need a bin on site for the duration rather than a single truck visit. Call 403-204-7827 and we will talk it through before anything is booked.",
        ],
      },
      {
    ...
    process: [
      ...
      },
      {
        ...
        detail:
          "Handover date, possession, or a City bylaw compliance notice. Tell us on the first call at 403-204-7827.",
      },
      {
...

  {
    ...
    description:
      "Construction and demolition waste removal for Calgary and Airdrie job sites. Bins, swaps and contractor accounts. 403-204-7827.",
    summary:
    ...
    process: [
      {
        ...
        detail:
          "Call 403-204-7827 with the scope and the trade sequence. Waste volume follows a predictable shape and the schedule should follow it.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Yes. A standing arrangement with known bin sizes and scheduled swaps works far better than booking job by job. Call 403-204-7827 and speak to Ted directly.",
      },
      {
