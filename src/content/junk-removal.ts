...
export const junkRemovalServices: Service[] = [
  {
    ...
    description:
      "Fridge, freezer, washer, dryer and stove removal in Calgary and Airdrie. We carry it out — stairs included. From $50. Call 403-509-2783.",
    summary:
    ...
    process: [
      {
        ...
        detail:
          "Call 403-509-2783 with the appliance type and which floor it is on. A photo texted over is even better. You get a price on that call.",
      },
      {
        step: "Book a window",
        detail:
...

  {
    ...
    description:
      "Couch, sectional, bed, table and desk removal across Calgary and Airdrie. We carry it out and haul it away. From $50 — call 403-509-2783.",
    summary:
    ...
    process: [
      {
        ...
        detail:
          "Call 403-509-2783 with what is going and which floor it is on. Photos help us price it accurately first time.",
      },
      {
...

  {
    ...
    description:
      "Mattress and box spring removal in Calgary and Airdrie. Any size, picked up from inside the home. From $50 — call 403-509-2783.",
    summary:
    ...
    process: [
      {
        ...
        detail:
          "403-509-2783. Tell us the mattress size, how many pieces, and which floor. You get a price on the call.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Pickups start at $50, and a mattress with its box spring is usually a single-item price rather than two. Call 403-509-2783 and you get the number on the phone.",
      },
      {
    ...
    process: [
      {
        ...
        detail:
          "We look at the garage with you and you tell us what stays. Photos over text to 403-509-2783 work for an initial number.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "It depends on volume and weight. A partly full single-car garage is often a truckload; a double-car garage packed floor to ceiling is usually a bin. Jobs start at $50 and you get a firm number before we load. Call 403-509-2783.",
      },
      {
    ...
    process: [
      {
        ...
        detail:
          "Call 403-509-2783. Tell us the size of the house, the deadline and where you are in the process. There is no pressure to book on that call.",
      },
      {
        step: "Walk the house",
        detail:
    ...
    faqs: [
      {
        ...
        a: "It is priced by volume and weight, and a full house is usually multiple loads or a bin over several days. We walk the property first so the number reflects the real job. Call 403-509-2783 to arrange that.",
      },
      {
    ...
    process: [
      {
        ...
        detail:
          "Call 403-509-2783 and say what it actually is — boxes, lumber, concrete, yard waste. Material matters more than volume for the price.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Jobs start at $50 and the price is driven by weight and volume. Tell us what the material actually is when you call 403-509-2783 — concrete and boxes are very different loads — and the number you get will hold.",
      },
      {
...

  {
    ...
    process: [
      {
        ...
        detail:
          "Call 403-509-2783. Branches, sod, fence panels and landscaping rock all price differently — describing the material gets you an accurate number.",
      },
      {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "It depends heavily on the material. Branches and leaves are light and go to compost, which is cheaper. Sod, soil and landscaping rock are dense and price higher. Call 403-509-2783 and describe the material.",
      },
      {
...

  {
    ...
    intro: [
      ...
      "For larger volumes of clean metal, the scrap value can offset most or all of the cost of the pickup. Call 403-509-2783, describe what you have, and we will tell you honestly where your job lands.",
    ],
    sections: [
      {
    ...
    process: [
      {
        ...
        detail:
          "Call 403-509-2783. Say roughly what it is and how much — a photo helps. Metal-heavy jobs price better and we will tell you so.",
      },
      {
    ...
    faqs: [
      {
        ...
        a: "Not automatically, but it is cheaper than general junk removal because the metal has value. On larger volumes of clean metal, the scrap value can offset most or all of the pickup cost. Call 403-509-2783 and describe what you have.",
      },
      {
